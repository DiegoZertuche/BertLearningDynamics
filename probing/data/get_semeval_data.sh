...
python data/convert-semeval2010-task8.py -i "${TRAIN_SOURCE}" \
    -o "$TARGET_DIR/train.all.json"
python data/convert-semeval2010-task8.py -i "${TEST_SOURCE}" \
...
python edge_data_stats.py -i $TARGET_DIR/*.json